...
export class Backend implements backendInterface {
    ...
    async addFeaturedId(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addFeaturedId(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getFeaturedIds(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFeaturedIds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getQualityLabel(arg0: string): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getQualityLabel(arg0);
    ...
    async removeFeaturedId(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeFeaturedId(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setContactInfo(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async setQualityLabel(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setQualityLabel(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
